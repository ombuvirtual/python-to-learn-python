...
# basic operations you can perform on these types of objects. In the
# next section we introduce equality and inequality operators that can
# be used to compare instances of these data types.
